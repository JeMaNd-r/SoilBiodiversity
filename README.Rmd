...
* Data can be downloaded according to Zeiss et al. 2022.

Folder structure should be maintained. Additionally, please start with loading the SoilBiodiversity.Rproj file, and load individual R scripts from there. This is necessary to access all data files that will be called with `here::here()`.
