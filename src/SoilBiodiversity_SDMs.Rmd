...
```{r numberOcc}
data.frame("No_species" = length(unique(speciesNames[speciesNames$Records>0,"Species"])),
           "No_speciesID" = length(unique(speciesNames[speciesNames$Records>0,"SpeciesID"])))
