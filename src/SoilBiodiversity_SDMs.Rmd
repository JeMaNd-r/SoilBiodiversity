...
First, raw occurrences as we downloaded them.

```{r plotOccRaw}
# load species list containing information on number of occurrence records in grid
occ.raw <- read.csv(file=paste0(here::here(), "/results/Occurrences_", Taxon_name, ".csv"))

# load background map
#...

# plot total species' occurrences
plotOccRaw <- ggplot(occ.raw, 
...
rm(plotOccRawGER, occ.raw)
```


Second, we plot the data we used for the models (i.e., the gridded or rasterized data).
