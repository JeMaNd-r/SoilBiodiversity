...
count_data <- count_data %>% full_join(speciesNames[,c("Species", "NumCells")], by=c("species" = "Species")) %>%
...
count_data[count_data$NumCells>=5, "Included"] <- TRUE 
