...
speciesSub <- unique(speciesNames[speciesNames$NumCells_2km_biomod >= 10,]$SpeciesID)
...
for(spID in speciesSub){ try({
  ...
  save(maxent_list, file=paste0(here::here(), "/results/_TopPredictor/SDM_maxent_", spID, ".RData"))
...
#- - - - - - - - - - - - - - - - - - - - - -
## Save species stack 
save(species_stack, file=paste0(here::here(), "/results/_TopPredictor/SDM_stack_MaxEnt_binary0.8_", Taxon_name, ".RData"))
...
## OPTIONAL ####
## This part was necessary only if using different pseudo-absence datasets for MaxEnt vs. Biomod.
# #- - - - - - - - - - - - - - - - - - - - - -
# #- - - - - - - - - - - - - - - - - - - - - -
# #- - - - - - - - - - - - - - - - - - - - - -
# #- - - - - - - - - - - - - - - - - - - - - -
