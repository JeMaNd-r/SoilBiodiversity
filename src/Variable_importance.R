...
var_imp_temp <- data.frame("Predictor"= c("Aridity", "MAP", "MAP_Seas", "MAT", 
...
var_imp$ensemble <- round(rowMeans(var_imp[,c("gm", "lasso", "brt2", "rf2", "maxent")], na.rm=T),3)
